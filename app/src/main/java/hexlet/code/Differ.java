...
public class Differ {
    ...
    public static Map<String, Object> readAndConvertFile1() throws IOException {
        ...
        if (Paths.get(absolutFilepath1).isAbsolute()) {
            content = new String(Files.readAllBytes(Paths.get(absolutFilepath1)));
        } else {
            content = new String(Files.readAllBytes(Paths.get(relativePath1)));
        }
    ...
    public static Map<String, Object> readAndConvertFile2() throws IOException {
        ...
        if (Paths.get(absolutFilepath2).isAbsolute()) {
            content = new String(Files.readAllBytes(Paths.get(absolutFilepath2)));
        } else {
            content = new String(Files.readAllBytes(Paths.get(relativePath2)));
        }
